// healthhub\src\Components\Footer.js
                                ...
                                <ul className="list-unstyled">
                                    ...
                                    {workoutDropdown && (
                                        <ul className="list-unstyled ms-3  bg-white  p-2 rounded shadow">
                                            <li className="d-flex align-items-center">
                                                <i className="fa fa-chevron-right text-warning me-2"></i>
                                                <a href="/home-workouts" className="text-dark text-decoration-none">Home Workout</a>
                                            </li>
                                            <li className="d-flex align-items-center">
                                                <i className="fa fa-chevron-right text-warning me-2"></i>
                                                <a href="/gym-workouts" className="text-dark text-decoration-none">Gym Workout</a>
                                            </li>
                                        </ul>
                                    )}
